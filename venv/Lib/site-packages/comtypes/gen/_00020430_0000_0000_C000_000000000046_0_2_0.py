...
IFontDisp = Font
__all__ = [ 'Picture', 'OLE_COLOR', 'OLE_YSIZE_CONTAINER',
           'OLE_HANDLE', 'FontEvents', 'IPictureDisp', 'Gray',
           'Checked', 'OLE_XSIZE_CONTAINER', 'OLE_XSIZE_PIXELS',
           ...
           'OLE_XPOS_PIXELS', 'IFont', 'OLE_XSIZE_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'FONTNAME', 'Default',
           'OLE_YPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'Font', 'FONTSIZE', 'VgaColor',
           'Color', 'IFontEventsDisp', 'IPicture', 'StdFont',
           'FONTSTRIKETHROUGH', 'Unchecked', 'OLE_TRISTATE',
           'StdPicture', 'FONTITALIC', 'OLE_XPOS_HIMETRIC']
